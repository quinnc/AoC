...
namespace Day11
{
    class CodeRunner 
    {
        ...
        protected bool SetOutput(int curr, int paramOffset, char mode, int val)
        {
            string valStr = val.ToString();
            return SetOutput(curr, paramOffset, mode, valStr);
        }

        protected bool SetOutput(int curr, int paramOffset, char mode, string val)
        {
            bool ok = false;
        ...
        protected bool GetInputs(int curr, int numParams, char modeParam1, out int input1, char modeParam2, out int input2)
        {
            input1 = 0;
            input2 = 0;
        ...
        protected bool GetInput(int param, char mode, out int val)
        {
            bool ok = false;
            val = 0;
        ...
        protected void SetData(int address, string val)
        {
            if (address >= data.Length)
            {
